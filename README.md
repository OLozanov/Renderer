...
Renderer features trilinear filtering, alpha test and blending, forward+ lighting with omni lights and directinal light with shadow.<br>
On Alder Lake Intel Core i5 with 12 hardware threads I got average 60 fps with lighting on.<br><br>
Controls:<br>
&emsp;w - forward<br>
&emsp;s - backward<br>
